...
void People::AddInfor() {
    printTabs(4); cout << "Full Name            : "; getline(cin, FullName);
    ...
    printTabs(4); cout << "Address Email        : "; getline(cin, AddressEmail);
}      
...
void People::DisplayInfor() const {
    ...
    printTabs(4); cout << "Address Email        : " << AddressEmail << endl;
}